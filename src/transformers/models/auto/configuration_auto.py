...
from ..image_gpt.configuration_image_gpt import IMAGE_GPT_PRETRAINED_CONFIG_ARCHIVE_MAP, ImageGPTConfig
...
ALL_PRETRAINED_CONFIG_ARCHIVE_MAP = dict(
    ...
    for pretrained_map in [
        ...
        IMAGE_GPT_PRETRAINED_CONFIG_ARCHIVE_MAP,
